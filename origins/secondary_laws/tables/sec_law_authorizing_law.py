...
ODATA_NAME = "KNS_SecLawAuthorizingLaw"
TABLE_NAME = "sec_law_authorizing_law_raw"
ENSURE_INDEXES = [
    "CREATE INDEX IF NOT EXISTS idx_seclawauth_seclawid ON sec_law_authorizing_law_raw (SecondaryLawID)",
    "CREATE INDEX IF NOT EXISTS idx_seclawauth_authlawid ON sec_law_authorizing_law_raw (AuthorizingLawID)",
]

_COLS = ["Id", "AuthorizingLawID", "SecondaryLawID", "LastUpdatedDate"]
...
def create_table(conn) -> None:
    ...
    cur.execute(
        """
        CREATE TABLE IF NOT EXISTS sec_law_authorizing_law_raw (
            Id INTEGER PRIMARY KEY,
            AuthorizingLawID INTEGER,
