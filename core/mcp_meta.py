...
Attaches metadata as function attributes so that ``mcp_server.py`` and
``database_status_view.py`` can discover tools by inspecting the decorated
functions — no central registry needed.
